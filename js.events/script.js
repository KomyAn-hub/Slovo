...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('%c🕊️ БУДИНОК СЛОВА: РОЗСТРІЛЯНЕ ВІДРОДЖЕННЯ', 'color: #E63946; font-size: 20px; font-weight: bold;');
    console.log('%cВід розстріляного відродження до шістдесятників — нитка українського опору ніколи не обривалася', 'color: #D4A574; font-size: 14px; font-style: italic;');
});
